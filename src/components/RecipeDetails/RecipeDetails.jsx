...
const RecipeDetails = () => {
    const { getAllRecipes, getSingleRecipe } = useFunctions();
    ...
    useEffect(() => {
        setLoading(true)
        getSingleRecipe(recipe_id).then(data => setRecipe(data)).catch(error => console.error(error))
        getAllRecipes().then(data => setAllRecipes(data)).catch(error => console.error(error)).finally(() => setLoading(false))
    }, [recipe_id, getAllRecipes, getSingleRecipe]);
            ...
            <div className="recipe-details-body">
                <div className="body-left">
                    ...
                    <div className="blog-comments">
                        <BlogComments recipe_id={recipe._id} />
                    </div>
                </div>
